...
int main() {
    ...
    Robot Robo1("Robot 1", "Guard", 100);


    // Step 6: Use pointers to access Robot object
    Robot* robotPtr = &Robo1;
    ...
    modifyRobotByValue(Robo1);
    cout << "After modifyRobotByValue, Battery Life: " << Robo1.getBatteryLife() << "%\n";

    // Step 8: Pass by reference (changes persist)
    modifyRobotByReference(Robo1);
    cout << "After modifyRobotByReference, Battery Life: " << Robo1.getBatteryLife() << "%\n";
